...
import { IWidgetData, KanbanSynchronizersService, SynchronizerConfig } from '../Services/KanbanSynchronizersService';
...
export class RestController {
    constructor(
    private readonly syncService: KanbanSynchronizersService,
  ) {}
